(function () {
	...
	const translations = {
		"fr": {
			...
			"systemStatusMessage": "Tous les systemes sont operationnels. Derniere synchronisation: 27/03/2026 14:32 UTC.",
			...
			"category": "Côté",
			"categoryRocket": "Côté rocket",
			"categoryElectronics": "Côté électronique",
		...
		"en": {
			...
			"category": "Side",
			"categoryRocket": "Rocket side",
			"categoryElectronics": "Electronics side",
		...
		"de": {
			...
			"category": "Seite",
			"categoryRocket": "Rocket-Seite",
			"categoryElectronics": "Elektronik-Seite",
		...
		"lb": {
			...
			"heroTitle": "Suivi du vol de la fusée Exocet MM40",
			"heroSubtitle": "Verfollgung vum Raketeflich",
			...
			"categoryRocket": "Rocket Säit",
			"categoryElectronics": "Elektronik Säit",
			"overview": "Uewerbleck",
		...
		"es": {
			...
			"category": "Lado",
			"categoryRocket": "Lado del cohete",
			"categoryElectronics": "Lado electrónico",
